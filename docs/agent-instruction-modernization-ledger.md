...
- References to Odysseus PR #509 identify the superseded delivery attempt whose
  immutable review history is preserved. A replacement PR will own the final
  current-head delivery; until its number exists, rows say `replacement PR
...
evidence, or deployment evidence. The final replacement PR must publish one
