...
declare -A SENTINEL_FILES=(
    ...
    ["provisioning/Myrmidons"]="provisioning/Myrmidons/pyproject.toml"
    ["research/Odyssey"]="research/Odyssey/pyproject.toml"
    ["research/Scylla"]="research/Scylla/pyproject.toml"
